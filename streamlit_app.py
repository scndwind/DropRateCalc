...
drop_rate = st.number_input("Drop Rate (e.g., 11.76)", min_value=0.0, value=11.76)
...
attempts = st.number_input("Number of Attempts (kills/hr or boss kill)", min_value=1, value=100)
